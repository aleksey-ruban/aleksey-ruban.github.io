...
const productsList = [
    new Product("0092S30010", "/autoparts/catalog/photos/Bosch-0092S30010.jpg", 6800, "Bosch – 009 2S3 001 0", "Аккумулятор", 12, 1, 5, ["accumulators", "winter"]),
    new Product("560301052", "/autoparts/catalog/photos/varta_battary.png", 8200, "Varta – 560 301 052", "Аккумулятор", 3, 5, 5, ["accumulators", "winter"]),
    new Product("AGM12-18", "/autoparts/catalog/photos/Exide AGM12-18.jpg", 6500, "Exide AGM12-18", "Аккумулятор", 5, 2, 3, ["accumulators", "winter"]),
    new Product("EL752", "/autoparts/catalog/photos/Exide EL752.jpg", 16100, "Exide EL752", "Аккумулятор", 19, 1, 4, ["accumulators", "winter"]),
    new Product("78181", "/autoparts/catalog/photos/X'trike X-132.jpg", 6450, "X'trike – X-132 78181", "Диски", 20, 2, 4, ["disks"]),
    new Product("WMM579X1775A45X24", "/autoparts/catalog/photos/Advanti WLR5.jpg", 16500, "Advanti – WLR5 MM579", "Диски", 32, 1, 5, ["disks"]),
    new Product("WSQ79GX1775A45X05", "/autoparts/catalog/photos/Konig Impression SQ79G.jpg", 16500, "Konig Impression – SQ79G", "Диски", 8, 2, 4, ["disks"]),
    new Product("W01902201G1", "/autoparts/catalog/photos/OZ Monaco HLT.jpg", 23250, "OZ Monaco HLT – Grigio Corsa", "Диски", 4, 3, 5, ["disks"]),
    new Product("143550", "/autoparts/catalog/photos/Pirelli Ice Zero FR.jpg", 5820, "Pirelli – Ice Zero FR", "Шины", 48, 1, 5, ["tires", "winter"]),
    new Product("113426", "/autoparts/catalog/photos/Nokian Tyres Nordman.jpg", 6030, "Nokian Tyres Nordman 7", "Шины", 64, 2, 5, ["tires", "winter", "interestProducts"]),
    new Product("132703", "/autoparts/catalog/photos/Hankook Winter I*Pike.jpg", 6890, "Hankook Winter I*Pike", "Шины", 120, 1, 5, ["tires", "winter"]),
    new Product("774942", "/autoparts/catalog/photos/Michelin X-Ice North 4.jpg", 15200, "Michelin X-Ice North 4", "Шины", 52, 1, 5, ["tires", "winter"]),
    new Product("06J115403Q", "/autoparts/photos/s-l1600.jpg", 1450, "VAG - 06J 115 403 Q", "Маслянный фильтр", 257, 1, 5, ["filters", "engine"]),
    new Product("8K0201511A", "/autoparts/catalog/photos/VAG FuelFilter.jpg", 5100, "VAG – 8K0 201 511 A", "Топливный фильтр", 129, 1, 5, ["filters"]),
    new Product("F026400425", "/autoparts/catalog/photos/BOSCH AirFilter.jpg", 2490, "BOSCH F02 640 042 5", "Воздушный фильтр", 83, 1, 4, ["filters", "engine", "interestProducts"]),
    new Product("4M0819439B", "/autoparts/catalog/photos/VAG CabinFilter.jpg", 1850, "VAG 4M0 819 439 B", "Салонный фильтр", 142, 1, 4, ["filters"]),
    new Product("0242140523", "/autoparts/photos/spark_plug.jpg", 1100, "Bosch – 0 242 140 523", "Свеча зажигания", 140, 1, 5, ["engine"]),
    new Product("2483710", "/autoparts/photos/oil.jpg", 1290, "G-Energy 5W-40", "Масло моторное", 56, 1, 5, ["engine", "interestProducts"]),
    new Product("NO138493", "/autoparts/photos/drain_plug_gasket.jpg", 59, "VAG – NO138493", "Прокладка сливной пробки", 38, 2, 5, ["engine"]),
    new Product("4K0698151", "/autoparts/photos/front_brake_pads.jpg", 17500, "VAG – 4K0698151", "Тормозные колодки передние", 14, 3, 5, ["brakes"]),
    new Product("B000750M1", "/autoparts/photos/brake_fluid.jpg", 650, "VAG - B 000 750 M1", "Тормозная жидкость DOT4", 16, 2, 5, ["brakes"]),
    new Product("A07396S", "/autoparts/catalog/photos/AWS A07396S.jpg", 200, "AVS AVK-400 A07396S", "Стеклоомыватель", 41, 1, 4, ["windshieldWashers", "winter", "interestProducts"]),
    new Product("LN1314", "/autoparts/catalog/photos/LAVR Ln1310.jpg", 374, "LAVR Ln1314", "Стеклоомыватель", 2, 1, 5, ["windshieldWashers", "winter"]),
];
